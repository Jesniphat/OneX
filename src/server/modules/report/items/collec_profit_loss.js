  ...
  PH: [
    {
      ...
      items: [
        ...
        { type: 'text', x: 0, y: 8, w: 559, h: 22, fontSize: 18, text: 'รายการหักเงินลูกค้าหนี้ตามไม่ได้', bold: true, align: 'center' },
        ...
        { type: 'text', align: 'center', bold: true, fontSize: 13, w: 70, h: 12, x: 417, y: 62, text: 'หักเจ๊', },
        { type: 'text', align: 'center', bold: true, fontSize: 13, w: 70, h: 12, x: 417, y: 78, text: '50% 60% 70%', },
        { type: 'text', align: 'center', bold: true, fontSize: 13, w: 70, h: 12, x: 487, y: 62, text: 'หักพนักงาน', },
        { type: 'text', align: 'center', bold: true, fontSize: 13, w: 70, h: 12, x: 487, y: 78, text: '50% 60% 70%', },
  ...
  DT: [
    {
      ...
      items: [
        ...
        { type: 'text', align: 'center', fontSize: 12, w: 62, h: 8, x: 195, y: 4, field: 'name', },
        { type: 'text', align: 'center', fontSize: 12, w: 32, h: 8, x: 265, y: 4, field: 'unit', },
  ...
  RF: [
    {
      ...
      items: [
        ...
        { type: 'text', align: 'right', fontSize: 12, bold: true, w: 108, h: 8, x: 191, y: 2, text: 'สรุปยอด', },
        { type: 'line', x1: 301, x2: 301, y1: 0, y2: 20, lineWidth: 0.5, },
        { type: 'line', x1: 359, x2: 359, y1: 0, y2: 20, lineWidth: 0.5, },
        { type: 'line', x1: 359, x2: 359, y1: 0, y2: 20, lineWidth: 0.5, },
        { type: 'line', x1: 417, x2: 417, y1: 0, y2: 20, lineWidth: 0.5, },
        ...
        { type: 'line', x1: 557, x2: 557, y1: 0, y2: 20, lineWidth: 0.5, },
        { type: 'line', x1: 557, x2: 557, y1: 0, y2: 20, lineWidth: 0.5, },
        { type: 'line', x1: 301, x2: 557, y1: 18, y2: 18, lineWidth: 0.5 },
        { type: 'line', x1: 301, x2: 557, y1: 20, y2: 20, lineWidth: 0.5 },
      ]
    }
  ],
  PF: [
