  ...
  DT: [
    {
      ...
      items: [
        ...
        { type: 'text', align: 'left', fontSize: 10, w: 92, h: 38, lineHeight:0.7, x: 41, y: 0, field: 'contact_name', },
        { type: 'text', align: 'left', fontSize: 10, w: 137, h: 38, lineHeight:0.7, x: 141, y: 0, field: 'address', },
        { type: 'text', align: 'left', fontSize: 10, w: 47, h: 38, lineHeight:0.7, x: 286, y: 0, field: 'tel', },
        { type: 'text', align: 'left', fontSize: 10, w: 39, h: 38, lineHeight:0.7, x: 341, y: 0, text: '', },
        { type: 'text', align: 'right', fontSize: 10, w: 32, h: 38, lineHeight:0.7, x: 388, y: 0, field: 'qty', },
