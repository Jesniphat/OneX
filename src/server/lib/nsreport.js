  ...
  while (row < totalRows) {
    ...
    if (printHeader===true) {
      ...
      for (var i = 0; i < reportDefinition.PH.length; i++) {
        ...
        // console.log('measureSection.PH::', height, row);
      }
    ...
    for (var i = 0; i < reportDefinition.DT.length; i++) {
      ...
      //onsole.log('page', page, 'row', row, contentHeight, flag_group, group_row);
      if(!flag_group) {
...
//          console.log('numFont[1]=', this.numFont[1]);
        ...
        this.pdfKitDoc.registerFont('THSarabunNew'+this.numFont[1]+'-Bold', fontBold, 'TH Sarabun New Bold');
        doc.font('THSarabunNew'+this.numFont[1]+'-Bold');
      } else {
        this.fontCount[0]++;
...
//          console.log('numFont[0]=', this.numFont[0]);
        ...
        this.pdfKitDoc.registerFont('THSarabunNew'+this.numFont[0], fontNormal, 'TH Sarabun New');
        doc.font('THSarabunNew'+this.numFont[0]);
      }
