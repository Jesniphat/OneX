...
var resetData = {
  ...
  e_mail:'',
  note:'',
  birthday:helper.dateToString(new Date()),
  credit_term:1,
  serviceChargeText:'',
...
var CustomerEdit = React.createClass({
  ...
  getInitialState:function(){
    ...
    var person_id = this.props.params.id;
    ...
    return{
        ...
        is_active: {
          id: 'is_active_list',
          label: 'preliminary.add_new_customer.is_active',
          list:[
            {value:'YES', text:'YES'},
            {value:'NO', text:'NO'}
          ]
        ...
        memberTypeField: {
          id:'memberTypeFieldList',
          label:'preliminary.add_new_customer.member_type',
          list:[]
        },
        credit_term_status: {
          id: 'credit_term_status',
          label: 'preliminary.add_new_customer.credit_term_status',
          list:[
            {value:'APPROVE', text:tr.translate('preliminary.newsList.AP')},
            {value:'WAITAPPROVE', text:tr.translate('preliminary.newsList.NAP')}
          ]
        },
        customerTypeField: {
          id:'customerTypeFieldList',
          label:'preliminary.add_new_customer.customer_type',
          list:[
            {value:'PERSON', text:tr.translate('preliminary.customer_type_list.type_person')},
            {value:'COMPANY', text:tr.translate('preliminary.customer_type_list.type_company')}
          ]
        },
        customerTitle: {
          id:'customerTitleList',
          label:'preliminary.add_new_customer.titel',
          list:[
            {value:'N/A', text:'N/A'},
            {value:'Mr.', text:tr.translate('preliminary.list.mr')},
            {value:'Miss', text:tr.translate('preliminary.list.miss')},
            {value:'Mrs.', text:tr.translate('preliminary.list.mrs')}
          ]
        },
        customerIdType: {
          id:'customerIdTypeList',
          label:'preliminary.add_new_customer.type_id',
          list:[
            {value:'nationid', text:tr.translate('preliminary.list.nationid')},
            {value:'passport', text:tr.translate('preliminary.list.passport')},
            {value:'tax_id', text:tr.translate('preliminary.list.tax_id')}
          ]
        },
        customerGender: {
          id:'customerGenderList',
          label:'preliminary.add_new_customer.gender',
          list:[
            {value:'N/A',text:'N/A'},
            {value:'M',text:'male'},
            {value:'F',text:'female'}
        ...
        paymentType: {
          id:'paymentTypeList',
          label:'preliminary.add_new_customer.paymentTeprList',
          list:[
        ...
        currency: {
          id:'currencyList',
          label:'preliminary.add_new_customer.currency',
          list:[]
        },
  ...
  onGetMemberTypeDoneAction: function(data){
    ...
    console.log(list);
    this.state.memberTypeField.list = list;
    console.log(this.state.memberTypeField);
    this.setState({
      memberTypeField: this.state.memberTypeField
    });
    //console.log(this.state.memberTypeField);
  },
  ...
  onGetCustomerDataDoneAction: function(data){
    ...
    this.setState({
      ...
      doc1Name: data.document_name1,
      doc2Name: data.document_name2,
      doc3Name: data.document_name3
    });
  },
  ...
  onGetCompanyProfileDoneAction: function(res){
    this.setState({
      docnamelabel1:res.document1,
      docnamelabel2:res.document2,
      docnamelabel3:res.document3
    });
  },
  ...
  onSaveCustomersErrorAction: function(error){
    toasterActions.pop({
      type:'warning',
      message:'เพิ่มข้อมูลไม่สำเร็จ ' + error
    });
  },
  ...
  thisCheckUser: function(){
    console.log("chack user");
    if(this.state.edit_data.person_id == 0 || this.state.edit_data.person_id == "0"){
      console.log("chack user");
    }
  },

  onDropDoc1: function(files1){
    // console.log("path name = ",this.props.routes[3].path);
    this.setState({
      filename1: "Uploading... ["+files1[0].name+"]",
      disabled1: true
    });
    console.log("req = ", files1[0]);
    var req = {};
    req = request.post('/onex/api/upload/doc');
    req.attach("doc", files1[0]);
  ...
  onDropDoc2: function(files2){
    // console.log("path name = ",this.props.routes[3].path);
    this.setState({
      filename2: "Uploading... ["+files2[0].name+"]",
      disabled2: true
    });
    console.log("req = ", files2[0]);
    var req = {};
    req = request.post('/onex/api/upload/doc');
    req.attach("doc", files2[0]);
  ...
  onDropDoc3: function(files3){
    // console.log("path name = ",this.props.routes[3].path);
    this.setState({
      filename3: "Uploading... ["+files3[0].name+"]",
      disabled3: true
    });
    console.log("req = ", files3[0]);
    var req = {};
    req = request.post('/onex/api/upload/doc');
    req.attach("doc", files3[0]);
  ...
  render: function() {
    var fields = {
      customer_code:{
        id:'customer_code',
        label:'preliminary.add_new_customer.customer_code',
        maxLength:6
      },
      tax_num:{
        id:'tax_num',
        label:'preliminary.add_new_customer.tax_num',
        required:true,
        maxLength:13
      },
      member_code:{
        id:'member_code',
        label:'preliminary.add_new_customer.member_code'
      },
      names: {
        id:'names',
        label:'preliminary.add_new_customer.names',
        required:true
      },
      last_name:{
        id:'last_name',
        label:'preliminary.add_new_customer.last_name'
      },
      password: {
        id:'password',
        type:'password',
        label:'preliminary.add_new_customer.password',
        required:true
      },
      repassword: {
        id:'repassword',
        type:'password',
        label:'preliminary.add_new_customer.repassword',
        required:true
      },
      e_mail: {
        id:'e_mail',
        label:'preliminary.add_new_customer.e_mail',
        required:true
      },
      note:{
        id:'note',
        label:'preliminary.add_new_customer.note'
      },
      birthday:{
        id:'birthday',
        type: 'date',
        label:'preliminary.add_new_customer.birthday',
        required:true
      },
      remark:{
        id:'remark',
        label:'preliminary.add_new_customer.remark'
      },
      news:{
        id:'news',
        label:'preliminary.add_new_customer.news'
      },
      discount:{
        id:'discount',
        label:'preliminary.add_new_customer.discount'
      },
      credit_term:{
        id:'credit_term',
        label:'preliminary.add_new_customer.credit_term'
      },
      defaultAddrNo:{
        id:'defaultAddrNo',
        label:'preliminary.add_new_customer.defaultAddrNo',
        required:true
      },
      defaultAddrSoi:{
        id:'defaultAddrSoi',
        label:'preliminary.add_new_customer.defaultAddrSoi',
        required:true
      },
      defaultAddrTambon:{
        id:'defaultAddrTambon',
        label:'preliminary.add_new_customer.defaultAddrTambon',
        required:true
      },
      defaultAddrAmphur:{
        id:'defaultAddrAmphur',
        label:'preliminary.add_new_customer.defaultAddrAmphur',
        required:true
      },
      defaultAddrProvince:{
        id:'defaultAddrProvince',
        label:'preliminary.add_new_customer.defaultAddrProvince',
        required:true
      },
      defaultAddrZipCode:{
        id:'defaultAddrZipCode',
        label:'preliminary.add_new_customer.defaultAddrZipCode',
        required:true
      },
      defaultAddrPhone:{
        id:'defaultAddrPhone',
        label:'preliminary.add_new_customer.defaultAddrPhone'
      },
      contactName:{
        id:'contactName',
      ...
      serviceChargeText:{
        ...
        label:'preliminary.add_new_customer.serviceChargeText'
      },
      serviceChargeAmount:{
        id:'serviceChargeAmount',
        label:'preliminary.add_new_customer.serviceChargeAmount'
      },
      billingCode:{
        id:'billingCode',
        label:'preliminary.add_new_customer.billingCode'
      },
      billingName:{
        id:'billingName',
        label:'preliminary.add_new_customer.billingName'
      },
      billingAddr1:{
        id:'billingAddr1',
        label:'preliminary.add_new_customer.billingAddr1'
      },
      billingAddr2:{
        id:'billingAddr2',
        label:'preliminary.add_new_customer.billingAddr2'
      },
      billingTambon:{
        id:'billingTambon',
        label:'preliminary.add_new_customer.billingTambon'
      },
      billingAmper:{
        id:'billingAmper',
        label:'preliminary.add_new_customer.billingAmper'
      },
      billingProvince:{
        id:'billingProvince',
        label:'preliminary.add_new_customer.billingProvince'
      },
      billingZipcode:{
        id:'billingZipcode',
        label:'preliminary.add_new_customer.billingZipcode'
      },
      billingOtherNo:{
        id:'billingOtherNo',
        label:'preliminary.add_new_customer.billingOtherNo'
      },
      billingLiveYear:{
        id:'billingLiveYear',
        label:'preliminary.add_new_customer.billingLiveYear'
      },
      billingRemark:{
        id:'billingRemark',
        label:'preliminary.add_new_customer.billingRemark'
      },
      billingSend:{
        id:'billingSend',
        label:'preliminary.add_new_customer.billingSend'
      },
      billingNote:{
        id:'billingNote',
        label:'preliminary.add_new_customer.billingNote'
      },
      billingPayment:{
        id:'billingPayment',
        label:'preliminary.add_new_customer.billingPayment'
      },
      penalty:{
        id:'penalty',
    ...
    var contactList = [
      {name:'num',label:'preliminary.inTable.no',width:50,render:function(row, i){
        return (i+1);
      }},
      {name:'contactName',label:'preliminary.inTable.contactNameInTable',width:100, render:function(row){
        return row.contactName;
      }},
      {name:'contactPhoneNo',label:'preliminary.inTable.contactPhoneNoInTable',width:100, render:function(row){
    ...
    var billingList = [
      ...
      {name:'billingCode',label:'preliminary.inTable.contactCodeInTableBill',width:120, render:function(row){
        return row.billingCode;
      }},
      {name:'actions1',label:'preliminary.inTable.defaultBill', type:'actions', width:(2*15)+'px',width:50, render:function(row,i) {
        var h = function() {
    ...
    var listTab = [
      {id:'tab1', icon:'account4', text:'preliminary.tab.initial_tab'},
      {id:'tab2', icon:'home149', text:'preliminary.tab.default_addr_tab'},
      {id:'tab3', icon:'list89', text:'preliminary.tab.billing_data'},
      {id:'tab4', icon:'user157', text:'preliminary.tab.contract_name'},
      {id:'tab5', icon:'upload120', text:'preliminary.tab.uploadDoc'}
    ];
      ...
      <div className="layout-panel content-page">
        <div className="content-header boxf flex">
          <div className="panelf can-grow">
            <T content="preliminary.title.headNew" component="h5" />
          </div>
        ...
        <div className="content-body panelf">
          ...
          <div className="box9 flex flex-form">
            ...
            <div className="panel3" style={this.state.data.customerTypeFieldList=='PERSON' ? {display:'block'} : {display:'none'}}>
               <FlexTextInput
          ...
          <div className="box9 flex flex-form" style={this.state.data.customerTypeFieldList=='COMPANY' ? {display:'block'} : {display:'none'}}>
          ...
          <div className="panel10" style={{width:'960px'}}>
            ...
            <div className="panel10" style={this.state.curTab=='tab2' ? {display:'block'} : {display:'none'}}>
              <div className="box6 flex flex-form">
                <div className="panel6" style={{width: '544px'}}>
            ...
            <div className="panel10" style={this.state.curTab=='tab3' ? {display:'block'} : {display:'none'}}>
              <div className="box10 flex flex-form">
                ...
                <div className="panel6">
                        <div className="box5 flex flex-form">
                          ...
                          <div className="panel3" style={{width:'305px'}}>
                        ...
                        <div className="box5">
                          <div className="panel5" style={{width:'480px'}}>
                              <FlexTextInput
            ...
            <div className="panel10" style={this.state.curTab=='tab4' ? {display:'block'} : {display:'none'}}>
              <div className="box10 flex flex-form">
                <div className="panel6">
                  <div className="box4">
                    <FlexDisplayTable
                ...
                <div className="panel6">
                        ...
                        <div className="box5 flex flex-form">
                          <div className="panel5" style={{width: '484px'}}>
            ...
            <div className="panel10" style={this.state.curTab=='tab5' ? {display:'block'} : {display:'none'}}>
              <div className="box4 flex flex-form">
