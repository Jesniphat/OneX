  ...
  return (
    <div className="flex">
      <div className="box5">
        ...
        <AddressInfo ref="coCardAddr"  otherLabel="contract.address.year" onChange={function(newData) {
      ...
      <div className="box5">
        ...
        <AddressInfo ref="coAddr"  otherLabel="contract.address.year" onChange={function(newData) {
