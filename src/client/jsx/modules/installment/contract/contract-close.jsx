  ...
  getInitialState: function() {
    ...
    return {
      ...
      fields: [
        ...
        {name:'mysql_contract_code', title:'contract.contract', width:'150px', render:function(row){
          return row.mysql_contract_code;
        }},
        {name:'sell_date', type:'date', title:'contract.sell_date', width:'88px', render:function(row) {
          //console.log(row.sign_date.substr(0,10));
        ...
        {name:'cus_name', title:'contract.cus_name', width:'150px'},
