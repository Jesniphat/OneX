...
App.Index = React.createClass({
  componentDidMount: function() {
    ...
    menuActions.show([
      {id:'dashboard', route:'/fare-transport', label:'transport.menu.dashboard', icon:'show6',acl:['pos']},
      {id:'loadfareZone', route:'/fare-transport/loadfare/zone', label:'transport.menu.loadfareZone', icon:'download166',acl:['M_TRANSPORT_FARE']},
      {id:'loadfareRate', route:'/fare-transport/loadfare/rate', label:'transport.menu.loadfareRate', icon:'download166',acl:['M_TRANSPORT_FARE']}
    ]);
  },
  render: function() {
