...
var CustomerEdit = React.createClass({
  ...
  getInitialState:function(){
    ...
    if(system.sessionStore.getSession().staff.id == 'unidentified' || system.sessionStore.getSession().staff.id == null
      || system.sessionStore.getSession().staff.id == 0 || system.sessionStore.getSession().staff.id == '0'){
      var person_id = '0';
      var cTab = 'tab1';
    }else {
      ...
      <div className="layout-panel content-page" style={{padding:"0px 35px"}}>
        ...
        <div className="content-body panelf">
          <div className="box9 flex flex-form">
            <div className="panel2" style={{'width':'163px'}}>
                <FlexTextInput
            ...
            <div className="panel4" style={{'width':'348px'}}>
                <FlexDropdown
          ...
          <div className="box9 flex flex-form">
            ...
            <div className="panel4" style={{'width':'348px'}}>
             ...
             <div style={this.state.data.customerTypeFieldList=='PERSON' ? {display:'block'} : {display:'none'}}>
             <div className="panel4" style={{'width':'348px'}}>
                <FlexTextInput
          ...
          <div className="box9 flex flex-form">
            <div className="panel3" style={{'width':'348px'}}>
                <FlexTextInput
                  field={fields.e_mail}
                  data={this.state.data}
                  onChange={this.handleChange}
          ...
          <div className="panel9" style={{'width':'865px'}}>
            ...
            <div className="panel9" style={this.state.curTab=='tab3' ? {display:'block'} : {display:'none'}}>
              ...
              <div className="box6 flex flex-form" style={{'width':'544px'}}>
                <div className="panel6">
              ...
              <div className="box9 flex flex-form">
                ...
                <div>
                        <div className="box5 flex flex-form">
                          ...
                          <div className="panel3" style={{'width':'298px'}}>
                        ...
                        <div className="box5">
                          <div className="panel5" style={{'width':'474px'}}>
                              <FlexTextInput
                        ...
                        <div className="box5 flex flex-form">
                          <div className="panel3" style={{'width':'237px'}}>
                              <FlexTextInput
            ...
            <div className="panel9" style={this.state.curTab=='tab5' ? {display:'block'} : {display:'none'}}>
              <div className="box9 flex flex-form">
                ...
                <div className="panel6">
                        <div className="box5 flex flex-form">
                          <div className="panel3" style={{'width':'224px'}}>
                        ...
                        <div className="box5 flex flex-form">
                          <div className="panel5" style={{'width':'448px'}}>
