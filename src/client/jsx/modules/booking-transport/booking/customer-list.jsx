...
//    var shops = system.acl.getShopAcl();
    ...
    return {
      ...
      fields: [
        {name:'customer_code', title:'custometTabel.customer_code'},
        {name:'fullname', title:'custometTabel.fullname'},
        {name:'type', title:'custometTabel.type'},//, width:'80px'
        {name:'member_type_name', title:'custometTabel.nation'},
        ...
        {name:'actions', type:'actions', width:(2*28+8)+'px', render:function(row) {
          ...
          return (<div className="flex">
            <div onClick={e}>
              <FlexIcon icon="forward19" title="action.select"></FlexIcon>
            </div>
          </div>);
        }.bind(this)},
      ]
  ...
  onLinkToEdit: function(id) {
    console.log(id);
    this.props.history.pushState(null, '/booking-transport/booking/booking_new/' + id);
  },
      ...
      <div className="layout-panel content-page">
        <div className="content-header boxf flex">
          <div className="panelf can-grow">
            <T content="customerForm.title.head" component="h3" />
          </div>
