module.exports = {
  ...
  payment_tracking:{
    dialogChangList: "Change Payment Status"
  },
  action:{
    select: "Select",
    cancel: "Cancel",
    change: "Change to wait assign"
  },
  transport: {
    title: {
      index: 'Overview',
      ...
      headDeliveryList: 'Delivery list',
      headIntransitList: 'In transit list',
      newPickup: 'New pickup',
      newDelivery: 'New delivery',
      newIntransit: 'New in transit'
    },
    head: {
      headName: 'Load Fare'
    },
    menu: {
      ...
      booking: 'Booking',
      pickup: 'Pickup',
      pickupReceipt: 'Pickup receipt',
      intransitReceipt: "In transit receipt",
      delivery: "Delivery",
