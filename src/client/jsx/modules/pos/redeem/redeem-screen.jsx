...
var actionsReceipt = require('../receipt/actions');
var actionsRedeem = require('./actions');
...
var RedeemScreen = React.createClass({
  ...
  mixins: [
    Reflux.listenTo(actionsRedeem.checkredeem.done, 'onCheckRedeemDoneAction'),
    Reflux.listenTo(actionsRedeem.checkredeem.error, 'onCheckRedeemErrorAction'),
...
//          width:196,
  ...
  onCheckRedeemDoneAction: function(data){
  ...
  onCheckRedeemErrorAction: function(data){
...
//    console.log('read id card');
  ...
  render: function() {
          ...
          <div className="panel5 flex-v">
            <div className="flex">
              ...
              <div className="can-grow" style={{fontSize:'18pt',height:'40px',lineHeight:'48px',textAlign:'right',color:statusColor[contract.current_status]}}>
                ...
                <T content={contract.current_status == undefined ?'':'installment.contract.current_status.'+contract.current_status}/>
              </div>
            </div>
            <div>
              เริ่มสัญญา:<span style={{color:'blue',padding:'0 8px'}}>{contract.sign_date == undefined ? '':tr.localize(new Date(contract.sign_date), {type:'date', format:'long'})}</span>
    ...
    return (
      <div className="content-page layout-panel flex-form">
        <div className="content-header boxf flex">
          ...
          <div className="panel2 no-shrink">
            <FlexButton icon="forward19" label="pos.action.redeem.confirm"
              default={true}
