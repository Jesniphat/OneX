...
var RedeemScreen = React.createClass({
  ...
  mixins: [
    Reflux.listenTo(actionsRedeem.checkproduct.done, 'onCheckproductDoneAction'),
    Reflux.listenTo(actionsRedeem.saveCloseChange.done, 'onSaveCloseChangeDoneAction'),
...
//          width:196,
  ...
  onCheckproductDoneAction: function(data){
  ...
  onSaveCloseChangeDoneAction:function(data){
    toasterActions.pop({
      type:'success',
  ...
  onCheckproductErrorAction: function(data){
...
//    console.log('read id card');
  ...
  render: function() {
    ...
    var contractSummary = (
      <div className="contract-section layout-panel">
        <div className="flex">
    ...
    return (
      <div className="content-page flex-form">
        <div className="content-header boxf flex">
          ...
          <div className="panel2 no-shrink">
            <FlexButton icon="forward19" label="pos.action.confirm"
              default={true}
