...
var pendingStore     = require('./store');
...
var List = React.createClass({
      ...
      fields: [
        ...
        {name:'actions', type:'actions', width:(2*28+8)+'px', render:function(row) {
          return (<div className="flex">
            <FlexIcon to={"/pos/sell/"+row.id} icon="right244" title="action.select"></FlexIcon>
          </div>);
        }.bind(this)}
      ]
    }
  ...
  render: function() {
    ...
    var footnote = (
      <div><T content="info.footer.special" /></div>
    )
      ...
      <div className="content-page">
        <div className="content-header boxf flex">
          <div className="panelf can-grow">
            <T content="info.list" component="h2" />
          </div>
