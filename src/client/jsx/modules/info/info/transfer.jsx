...
var transferStore     = require('./transfer-store');
...
var InfoList = React.createClass({
  ...
  getInitialState: function() {
    ...
    return {
      ...
      fields: [
        {name:'trans_date', title:'info.total.date_in', width:'120px'},
        {name:'remark', title:'info.total.remark', width:'110px'},
        {name:'from_shop', title:'info.total.from_shop', width:'110px'},
        {name:'to_shop', title:'info.total.to_shop', width:'110px'},
        ...
        {name:'vat',className:'right', title:'info.total.vat', width:'60px'},
      ...
      <div className="content-page layout-panel">
        <div className="content-header boxf flex">
          <div className="panelf can-grow">
            <T content="title.list_transferinfo" component="h2" />
          </div>
