            ...
            <div className="header">
              <table>
                ...
                <thead>
                  <tr>
                    {this.props.checkbox ? (
                      <th className="flex"><span className={'flaticon-'+(this.state.checkedAll?'black399':'blank31')+' chk'} style={{ 'padding-top': 2 }} onClick={this.toggleAll}></span></th>) : null}
                    {thead}
                  </tr>
                  <SearchRow
