...
router.use('/inspection', require('./inspection/inspection'));
router.use('/contract', require('./contract/contract'));
router.use('/barcode', require('./barcode/barcode'));
router.use('/commission-open', require('./commission-open/commission'));
router.use('/commission-close', require('./commission-close/commission'));
