...
/***/ function(module, exports, __webpack_require__) {
	...
	var customerActions = __webpack_require__(518);
	var customerStore = __webpack_require__(519);
	...
	LoadFare.Index = _react2.default.createClass({
	  displayName: 'Index',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var zonerate = Reflux.createStore({
	  ...
	  onFareUpload: function onFareUpload(file, path) {
	    ...
	    var req = {};
	    if (path == 'zone') {
	      req = request.post('/securestock/api/upload/fare_zone');
	    } else if (path == 'rate') {
	      req = request.post('/securestock/api/upload/fare_rate');
	    }
	    req.attach("fare", file);
	    req.end(action.fareUpload.done);
	  },
	  // /api/bookingtransport/listWaitAssign'
	  onListFareZone: function onListFareZone() {
	  ...
	  onListFareRate: function onListFareRate() {
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  fareZoneTable: {
	    ...
	    district_origin: 'District origin',
	    country_destination: 'Country destination',
	    city_destination: 'City destination',
	    district_destination: 'District destination',
	    zone: 'Zone',
	    zone_import: 'Transport'
	  },
	  fareRateTable: {
	    no: 'NO.',
	    zone: 'Zone',
