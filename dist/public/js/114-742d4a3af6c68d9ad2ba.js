...
/***/ function(module, exports, __webpack_require__) {
	...
	var Emitter = __webpack_require__(521);
	var reduce = __webpack_require__(522);
	var requestBase = __webpack_require__(523);
	var isObject = __webpack_require__(524);
	...
	var request = module.exports = __webpack_require__(525).bind(null, Request);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _android = __webpack_require__(516);
	...
	var Dropzone = __webpack_require__(517);
	...
	var customerActions = __webpack_require__(986);
	var customerStore = __webpack_require__(987);

	var PointFare = {};

	tr.registerTranslations('en', __webpack_require__(988));
	tr.registerTranslations('th', __webpack_require__(989));

	var action = __webpack_require__(986);
	var ReFlux = __webpack_require__(337);

	PointFare = _react2.default.createClass({
	  displayName: 'PointFare',

	  mixins: [ReFlux.listenTo(action.fareUpload.done, 'onUploadDone')],
	  ...
	  onUploadDone: function onUploadDone(err, data) {
	    toasterActions.pop({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'content-header panelf', style: { marginRight: 40 } },
	        _react2.default.createElement(
	          _paper2.default,
	          { className: 'panel7', style: styles.depth, zDepth: 1 },
	          _react2.default.createElement(
	            Dropzone,
	            { ref: 'dropzone', disableClick: this.state.disabled, multiple: false, onDrop: this.onDrop, style: styles.dropzone },
	            _react2.default.createElement(
	              'div',
	              { className: 'flex' },
	              _react2.default.createElement(
	                'div',
	                { className: 'panel2' },
	                _react2.default.createElement('i', { className: 'flaticon-microsoft8 flatbig', style: { color: 'green' } })
	              ),
	              _react2.default.createElement(
	                'div',
	                { className: 'panel6', style: { textAlign: 'left' } },
	                _react2.default.createElement(T, { content: 'preliminary.fare.title', style: styles.title }),
	                _react2.default.createElement(
	                  'ol',
	                  null,
	                  _react2.default.createElement(
	                    'li',
	                    null,
	                    'Download and fill in Excel sheet.'
	                  ),
	                  _react2.default.createElement(
	                    'li',
	                    null,
	                    'The new spread sheet update will replace the existing one'
	                  )
	                )
	              )
	            ),
	            _react2.default.createElement(
	              'button',
	              { className: "ui positive button" + (this.state.disabled ? ' disabled' : ''), style: styles.button },
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              { onClick: this.DownloadTemplate, style: styles.link },
	              'click to download template xls file.'
	            )
	          )
	        )
	      ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var action = __webpack_require__(986);
	var request = __webpack_require__(520);

	var product = Reflux.createStore({
	  listenables: [action],
	  onFareUpload: function onFareUpload(file, path) {
	...
	module.exports = {
	  preliminary: {
	    fare: {
	      ...
	      point_import: 'นำเข้าข้อมูลพ้อยต์',
	      reword_import: 'นำเข้าข้อมูลรางวัล'
	    },
	    table: {
	      no: 'No.',
	      code: 'Group Code',
