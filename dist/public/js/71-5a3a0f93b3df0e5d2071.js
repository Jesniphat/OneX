...
/***/ function(module, exports, __webpack_require__) {
	...
	var storageKey = 'installment.contract.list';
	      ...
	      fields: [{ name: 'status', title: 'contract.contract_status', width: '86px',
	        sort: false, search: false, text: monthYear, render: function render(row) {
	          ...
	          return React.createElement(
	            'div',
	            { className: 'flex' },
	            React.createElement(FlexIcon, { to: 'installment.contract.edit', param: { id: row.id }, icon: 'right244', title: 'action.select' })
	          );
	        }.bind(this) }]
	    };
	  },
