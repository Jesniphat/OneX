...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tab = __webpack_require__(631);
	...
	var actions = __webpack_require__(622);
	...
	var bookingListActions = __webpack_require__(622);
	            ...
	            { name: 'pickup_date', title: 'transport.pickup_date' }, { name: 'type', title: 'transport.type' }, { name: 'real_delivery_date', title: 'transport.real_delivery_date' }, { name: 'booking_date', title: 'transport.booking_date' }, { name: 'actions', type: 'actions', width: 3 * 28 + 8 + 'px', render: function (row) {
	                    ...
	                    return React.createElement(
	                        ...
	                        React.createElement(
	                            'div',
	                            { onClick: f },
	                            React.createElement(FlexIcon, { icon: 'cancel19', title: 'action.select' })
	                        )
	                    );
	                }.bind(this) }]
	        };
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'div',
	                        { style: { height: '32px' } },
	                        React.createElement('div', { className: 'flaticon-been normal icon', style: { height: '32px', float: 'left' } }),
	                        React.createElement(
	                            'label',
	                            ...
	                            React.createElement(
	                                'b',
	                                null,
	                                'Wait confirm credit card payment'
	                            )
	                        )
	                    ),
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(FlexGrid, {
	                            ref: 'grid',
	                            id: 'transport-bookingList-listWaitClearCreditCard',
	                            listAction: bookingListActions.listWaitClearCreditCard,
	                            exportAction: bookingListActions.exportWaitClearCreditCard,
