...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductGroupList = React.createClass((_React$createClass = {
	  ...
	  return React.createElement(
	    ...
	    React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(FlexButton, (_React$createElement = {
	          label: 'preliminary.title.cancelCustomerBT',
	          icon: 'add186',
	          'default': false
	        }, _defineProperty(_React$createElement, 'label', 'preliminary.title.addProductGroupBT'), _defineProperty(_React$createElement, 'onClick', this.addProductGroup), _React$createElement))
	      )
	    ),
	    React.createElement(
	      'div',
