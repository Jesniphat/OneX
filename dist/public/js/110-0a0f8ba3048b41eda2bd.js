...
/***/ function(module, exports, __webpack_require__) {
	...
	var actions = __webpack_require__(967);
	...
	var CustomerEdit = React.createClass({
	  ...
	  getInitialState: function getInitialState() {
	    ...
	    return {
	      ...
	      credit_term_status: {
	        ...
	        list: [{ value: 'APPROVE', text: tr.translate('preliminary.newsList.AP') }, { value: 'WAITAPPROVE', text: tr.translate('preliminary.newsList.NAP') }]
	      },
	      customerTypeField: {
	        id: 'customerTypeFieldList',
	        label: 'preliminary.add_new_customer.customer_type',
	        list: [{ value: 'PERSON', text: tr.translate('preliminary.customer_type_list.type_person') }, { value: 'COMPANY', text: tr.translate('preliminary.customer_type_list.type_company') }]
	      },
	      customerTitle: {
	        id: 'customerTitleList',
	        label: 'preliminary.add_new_customer.titel',
	        list: [{ value: 'N/A', text: 'N/A' }, { value: 'Mr.', text: tr.translate('preliminary.list.mr') }, { value: 'Miss', text: tr.translate('preliminary.list.miss') }, { value: 'Mrs.', text: tr.translate('preliminary.list.mrs') }]
	      },
	      customerIdType: {
	        id: 'customerIdTypeList',
	        label: 'preliminary.add_new_customer.type_id',
	        list: [{ value: 'nationid', text: tr.translate('preliminary.list.nationid') }, { value: 'passport', text: tr.translate('preliminary.list.passport') }, { value: 'tax_id', text: tr.translate('preliminary.list.tax_id') }]
	      },
	      customerGender: {
	      ...
	      paymentType: {
	        ...
	        list: [{ value: 'credit', text: 'Credit Card' }, { value: 'billing', text: 'Billing' }]
	      },
	      currency: {
	        id: 'currencyList',
	  ...
	  onGetMemberTypeDoneAction: function onGetMemberTypeDoneAction(data) {
	    //console.log(data);
	  ...
	  render: function render() {
	    ...
	    var contactList = [{ name: 'num', label: 'preliminary.inTable.no', width: 50, render: function render(row, i) {
	        return i + 1;
	      } }, { name: 'contactName', label: 'preliminary.inTable.contactNameInTable', width: 100, render: function render(row) {
	        return row.contactName;
	      } }, { name: 'contactPhoneNo', label: 'preliminary.inTable.contactPhoneNoInTable', width: 100, render: function render(row) {
	        return row.contactPhoneNo;
	      } }, (_ref = { name: 'actions', type: 'actions', width: 2 * 15 + 'px' }, _defineProperty(_ref, 'width', 100), _defineProperty(_ref, 'render', function (row, i) {
	      var f = function () {
	    ...
	    // }},
	    var billingList = [{ name: 'num', label: 'preliminary.inTable.no', width: 50, render: function render(row, i) {
	        return i + 1;
	      } }, { name: 'billingCode', label: 'preliminary.inTable.contactCodeInTableBill', width: 120, render: function render(row) {
	        return row.billingCode;
	      } }, (_ref2 = { name: 'actions1', label: 'preliminary.inTable.defaultBill', type: 'actions', width: 2 * 15 + 'px' }, _defineProperty(_ref2, 'width', 50), _defineProperty(_ref2, 'render', function (row, i) {
	      var h = function () {
	    ...
	    }.bind(this)), _ref2), (_ref3 = { name: 'actions', type: 'actions', width: 2 * 15 + 'px' }, _defineProperty(_ref3, 'width', 50), _defineProperty(_ref3, 'render', function (row, i) {
	      var f = function () {
	    ...
	    var listTab = [{ id: 'tab1', icon: 'account4', text: 'preliminary.tab.initial_tab' }, { id: 'tab2', icon: 'home149', text: 'preliminary.tab.default_addr_tab' }, { id: 'tab3', icon: 'list89', text: 'preliminary.tab.billing_data' }, { id: 'tab4', icon: 'user157', text: 'preliminary.tab.contract_name' }];
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(T, { content: 'preliminary.title.headNew', component: 'h5' })
	        ),
	        React.createElement(
	          'div',
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'div',
	            { className: 'panel3', style: this.state.data.customerTypeFieldList == 'PERSON' ? { display: 'block' } : { display: 'none' } },
	            React.createElement(FlexTextInput, {
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            { className: 'panel3' },
	            React.createElement(FlexDropdown, {
	              field: this.state.memberTypeField,
	              data: this.state.data,
	              onChange: this.handleChange
	            })
	          ),
	        ...
	        React.createElement(
	          'div',
	          { className: 'box9 flex flex-form', style: this.state.data.customerTypeFieldList == 'COMPANY' ? { display: 'block' } : { display: 'none' } },
	          React.createElement(
	            'div',
	            { style: this.state.data.customerTypeFieldList == 'COMPANY' ? { display: 'block' } : { display: 'none' } },
	            React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { className: 'panel10', style: { width: '960px' } },
	        ...
	        React.createElement(
	          'div',
	          { className: 'panel10', style: this.state.curTab == 'tab3' ? { display: 'block' } : { display: 'none' } },
	          React.createElement(
	            'div',
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  'div',
	                  { className: 'panel3', style: { width: '305px' } },
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  'div',
	                  { className: 'panel5', style: { width: '480px' } },
	                  React.createElement(FlexTextInput, {
	        ...
	        React.createElement(
	          'div',
	          { className: 'panel10', style: this.state.curTab == 'tab4' ? { display: 'block' } : { display: 'none' } },
	          React.createElement(
	            'div',
	            { className: 'box10 flex flex-form' },
	            React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  'div',
	                  { className: 'panel5', style: { width: '484px' } },
